...
published_year INT CHECK(published_year<2028)
);
...
INNER JOIN Books2 b ON l.book_id = b.book_id;
...
INSERT INTO Books2 (book_id, title, isbn, published_year)
...
CREATE INDEX idx_books_isbn ON Books2(isbn);

SELECT * FROM Books2 WHERE isbn = '9780451524935';
